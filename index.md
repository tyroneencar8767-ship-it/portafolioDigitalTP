...
| **Lenguajes de programación** | Sistemas formales de comunicación con la computadora. Se clasifican en: lenguajes de bajo nivel (ensamblador) y alto nivel (Python, Java). C es un lenguaje compilado, eficiente y ampliamente usado en sistemas; PseInt es un pseudolenguaje educativo que simula la ejecución de pseudocódigo. |
...
### 2.3 Diseño del algoritmo (Diagrama de flujo PseInt)
## Unidad 2
